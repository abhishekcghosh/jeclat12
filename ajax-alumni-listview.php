<?php 
	...
	echo '<span style="font-weight: bold">From the ' . $year . ' Batch</span> <a class="link" style="font-size: 20px" id="pfv_link" href="alumni-pfv.php?y=' . $year . '" target="_blank"> - get a printer-friendly version</a><br /><br />';
