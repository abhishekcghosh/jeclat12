<?php
	function sendMail($name,$emailid,$message)
	{
		//send mail
			...
			$email_body_auto_reply = "Hello " . stripslashes($name) . ", \nThis is the auto reply message. Thank you for your feedback. \n\nFrom, \nAdmin \nwww.jeclat.in";
			$extra_auto_reply = "From: JECLAT 2012\r\nReply-To: " . stripslashes($receiver) . "\r\n" . "X-Mailer: PHP/" . phpversion();
			
			mail( $sender, "JECLAT 2012 Feedback :: Auto-reply", $email_body_auto_reply, $extra_auto_reply );
		
			mail( $receiver, "JECLAT 2012 :: Feedback", $email_body, $extra );
	}
?>
<?php 
