<?php
	function sendMail($emailid)
	{
		//send mail
			...
			$email_body_auto_reply = "Hello dada/didi, \n\nThis is the auto-reply message. Thank you for your registration on our website. \n\nFor any kind of information regarding the Alumni ReUnion at JECLAT 2012, please kindly contact: \n\nRamrup Chakraborty\nramrup.c@jeclat.in\n+91-9477428360\n\nMd. Azharuddin\nmd.azharuddin@jeclat.in\n+91-9635592517\n\nWith Sincere Regards, \nJECLAT 2012 COMMITTEE	\nwww.jeclat.in";
			$extra_auto_reply = "From: mail@jeclat.in\r\nReply-To: " . stripslashes($receiver) . "\r\n" . "X-Mailer: PHP/" . phpversion();
			mail( $sender, "JECLAT 2012 Alumni Registration :: Auto-reply", $email_body_auto_reply, $extra_auto_reply );
	}
?>
<?php 
	...
	$address=addslashes(strip_tags(trim($_POST['ad']))); 
