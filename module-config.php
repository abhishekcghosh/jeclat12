<?php
	...
	define("__SQL_TABLE_PREFIX__","j12_",true);						//MySQL Table name prefix for the site db
	...
	define("__SITE_WEBADDRESS__","http://www.jeclat.in/",true);				//Absolute website address, ** with trailing / **
